...
int main(int argc, char *argv[])
{
  ...
  if(argc < 7)
  {
        printf("Test case: bgfloat_CompDecomp [config_file] [solName] [varName] [nsd] [srcFilePath] [dimension sizes...]\n");
        printf("Example: bgfloat_CompDecomp zc.config sol var 5 testdata/x86/testfloat_8_8_128.dat 8 8 128\n");
        exit(0);
  }
