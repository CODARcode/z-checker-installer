...
int main(int argc, char *argv[])
{
  ...
  if(argc < 7)
  {
        printf("Test case: fpzip_CompDecomp_float [config_file] [solName] [varName] [srcFilePath] [dimension sizes...]\n");
        printf("Example: fpzip_CompDecomp_float zc.config sol var testdata/x86/testfloat_8_8_128.dat 8 8 128\n");
        exit(0);
  }
